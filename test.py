...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runsx3/train/exp56/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/hsi/hsi_twostream1.yaml', help='*.data path')
